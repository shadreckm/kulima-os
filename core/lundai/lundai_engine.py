...
if __name__ == "__main__":
    ...
    logger.info("Testing LUNDAI Engine...")
    logger.info("=" * 70)
    ...
    logger.info(f"  Average Adequacy: {overall['average_infrastructure_adequacy_score']}/100")
    logger.info(f"  Status: {overall['overall_infrastructure_status']}")
    logger.info("=" * 70)
